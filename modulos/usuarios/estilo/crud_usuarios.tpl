...
$(document).ready(function(){
  ...
  $(document).on('click', '.modal-btn', function(e){
    ...
    button = $(this).attr('id');
    ref = $(this).attr('href');
    url='./modal.php?mod=USUARIOS&submod=CRUD_USUARIOS&pag='+ref+'&accion='+action+'&id='+id;
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading titulares">
            <a id="bt_new" class="btn btn-default modal-btn" data-action="" href="form_usuarios" data-toggle="modal"><i class="fa fa-plus"></i> NUEVO</a>
          </div>
