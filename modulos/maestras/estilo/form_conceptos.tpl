...
$(document).ready(function(){
  ...
  $(document).on('click', '.btn', function(){
    ...
    function verificar(){
      var concepto='concepto',precio='precio',valido=true;
      valido = valido && validar(concepto);
      valido = valido && validar(precio);
      valido = valido && IsNumber(precio);
      return valido;
    }
    $(function(){
...
<div class="modal modals fade" id="form_conceptos" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade active in" id="principales">
                      <div class="col-xs-8 col-md-6">
                        <div id="concepto_g" class="form-group input-group">
                          <label class="control-label" for="concepto_c">CONCEPTO</label>
                          <input id="concepto_c" name="concepto_c" type="text" class="form-control" value="{CONCEPTO}">
                        </div>
                        <div id="precio_g" class="form-group input-group">
                          <label class="control-label" for="precio_c">PRECIO</label>
                          <input id="precio_c" name="precio_c" type="text" class="form-control numeric" value="{PRECIO}">
                        </div>
