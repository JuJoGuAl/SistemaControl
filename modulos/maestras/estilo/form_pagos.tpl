...
$(document).ready(function(){
  ...
  $(document).on('click', '.btn', function(){
    ...
    function verificar(){
      var pago='pago',cuenta='cuenta',valido=true;
      valido = valido && validar(pago);
      valido = valido && list(cuenta);
      return valido;
    }
    $(function(){
...
<div class="modal modals fade" id="form_pagos" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade active in" id="principales">
                      <div class="col-xs-8 col-md-8">
                        <div id="pago_g" class="form-group input-group">
                          <label class="control-label" for="pago_c">TIPO DE PAGO</label>
                          <input id="pago_c" name="pago_c" type="text" class="form-control" value="{TIPO_PAGO}">
                          <p class="help-block">Se recomienda especificar la Cuenta / Banco asociados al Tipo de pago, Ejemplo: EFECTIVO - BANESCO - CTE</p>
                        </div>
                        <div id="cuenta_g" class="form-group input-group">
                          <label class="control-label" for="cuenta_c">CUENTA</label>
                          <select name="cuenta_c" id="cuenta_c" class="form-control pais">
                            <option value="-1">SELECCIONE...</option>
                            <!-- START BLOCK : cuentas_det -->
                            <option value="{CODIGO_CUENTA}" {selected}>{TIPO}</option>
                            <!-- END BLOCK : cuentas_det -->
                          </select>
                        </div>
